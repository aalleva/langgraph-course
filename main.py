...
def main():
    ...
    print("Test 3: Temperature in London and triple it")
    res = app.invoke({"messages": [HumanMessage(content="What is the current temperature in London? List it and triple it")]})
    print(res["messages"][LAST].content)
    print()
